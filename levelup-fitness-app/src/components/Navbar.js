    ...
    <nav className={`inapp-navbar ${isOpen ? 'open' : ''}`}>
      ...
      <ul className="navbar-links">
        <li className="nav-item workout-icon">
          <Link to="/"><img className="workout-icon" src={nav_icon} alt="create workout icon" /></Link>
        </li>
        <li className="nav-item home-icon">
          <Link to="/feed"><img src={home_icon} alt="home icon"/></Link> 
        </li>
        <li className="nav-item hero-icon">
          <Link to="/hero"><img src={hero_icon} alt="hero icon" /></Link>
        </li>
